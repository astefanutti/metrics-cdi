...
import fr.stefanutti.metrics.cdi.bean.VisibilityTimedMethodBean;
...
public class VisibilityTimedMethodTest {
    ...
    public void callTimedMethodsOnce() {
        ...
        method("protectedTimedMethod").in(bean).invoke();
        method("packagePrivateTimedMethod").in(bean).invoke();
